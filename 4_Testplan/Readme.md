...
|  H_11      | Search a user by credential | username to search| Search successful & searched user data or Unsuccessful message | In Progress | Scenario based |
...
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|
|  L_01       |Fuction should check wether a given string contains any special character or not |String username| Boolean value indicating the existence of special characters in a given string| In Progress |Scenario based    |
|  L_01       |Fuction should check wether a given string contains any special character or not |"@SUMANTH"| true| In Progress |Scenario based    |
|  L_01       |Fuction should check wether a given string contains any special character or not |"#Ankit654"| true| In Progress |Scenario based   |
|  L_01       |Fuction should check wether a given string contains any special character or not |"####$!@$!$!FSD$#$@!#!@"| false| In Progress |Scenario based   |
...
|  L_02       |Function should check wether a given string contains numbers or not |"Hello"| false|----------------|Scenario based    |
|  L_02       |Function should check wether a given string contains numbers or not |"123password"|true|----------------|Scenario based    |
|  L_02       |Function should check wether a given string contains numbers or not |"####$!@$!$!FSD$#$@!#!@"|Boolean value indicating the existence of numbers in a given string|----------------|Scenario based    |
...
| **Test ID** | **Description**                                              | **Exp IN** | **Exp OUT** | **Actual Out** |**Type Of Test**  |    
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|
|  L_03       |A function should check whether a given string contain lower case letter or not|String input as parameter|Boolean value indicating the existence of lower case letters in a given string|----------------|Requirement based |
|  L_03       |A function should check wether a given string contain upper case letter or not |"Hello world"| true |----------------|Boundary based    |
|  L_03       |A function should check wether a given string contain upper case letter or not |"PWD"| false |----------------|Boundary based    |
|  L_03       |A function should check wether a given string contain upper case letter or not |"####$!@$!$!FS23D$#$@!#!@"| false |----------------|Boundary based    |
...
| **Test ID** | **Description**                                              | **Exp IN** | **Exp OUT** | **Actual Out** |**Type Of Test**  |    
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|
|  L_04       |A function should check whether a given string contain upper case letter or not|String input as parameter|Boolean value indicating the existence of upper case letters in a given string|----------------|Requirement based |
|  L_04       |A function should check whether a given string contain upper case letter or not|"operation"|false|----------------|Requirement based |
|  L_04       |A function should check whether a given string contain upper case letter or not|"Password"|true|----------------|Requirement based |
|  L_04       |A function should check whether a given string contain upper case letter or not|"####$!@$!$!FSD$er#$@!#!@"|true|----------------|Requirement based |
...
|  L_08       |Test the function which is used to call to delete the master user| current master data|status SUCCESS |----------------|Requirement based |
|  L_08       |Test the function which is used to call to delete the master user| current master data|status  FAILURE|----------------|Requirement based |
...
|  L_09       |Test the modify function for master account username|"newusername|status SUCCESS |----------------|Requirement based |
|  L_09       |Test the modify function for master account username|"oldusername","newusername123"|status  FAILURE|----------------|Requirement based |
...
|  L_10       |Test the modify function for master account password|"newpassword123"|status SUCCESS |----------------|Requirement based |
|  L_10       |Test the modify function for master account password|"oldpassword","newpassword123"|status  FAILURE|----------------|Requirement based |
...
| **Test ID** | **Description**                                              | **Exp IN** | **Exp OUT** | **Actual Out** |**Type Of Test**  |    
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|
|  L_11       |While creating a user,check if the master user already exists or not| master username stringsBoolean value based on the verification |status SUCCESS or FAILURE|----------------|Requirement based |
|  L_11       |While creating a user,check if the master user already exists or not|"username"|true|----------------|Requirement based |
|  L_11       |While creating a user,check if the master user already exists or not|"user555" |false|----------------|Requirement based |
...
|  L_19       |Show all credentials  | FILE *credential_file|status SUCCESS|----------------|Requirement based |
|  L_19       |Show all credentials  | FILE *credential_file|status FAILURE|----------------|Requirement based |
...
|  L_20       |Test for the function used to sort given user credentials according to organisation name |FILE FILE *credential_file |status SUCCESS|----------------|Requirement based |
|  L_20       |Test for the function used to sort given user credentials according to organisation name |FILE FILE *credential_file |status FAILURE|----------------|Requirement based |
...
|  L_21       |Test for the function used  check if credential exist or not in the system |"Apple","John"|status FAILURE|----------------|Requirement based |
|  L_21       |Test for the function used  check if credential exist or not in the system |"google","Smith"|status SUCCESS |----------------|Requirement based |
...
|  L_22       |Test for the function used to encrypt credential file | FILE *c_file_name|status FAILURE|----------------|Requirement based |
|  L_22       |Test for the function used to encrypt credential file | NULL |status FAILURE|----------------|Requirement based |
|  L_22       |Test for the function used to encrypt credential file | FILE *credential_file|status SUCCESS|----------------|Requirement based |
